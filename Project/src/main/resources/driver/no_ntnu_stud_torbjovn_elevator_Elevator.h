 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_no_ntnu_stud_torbjovn_elevator_Elevator_elev_1init
  (JNIEnv *, jobject);
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_no_ntnu_stud_torbjovn_elevator_Elevator_elev_1get_1floor_1sensor_1signal
  (JNIEnv *, jobject);
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_no_ntnu_stud_torbjovn_elevator_Elevator_elev_1get_1obstruction_1signal
  (JNIEnv *, jobject);
